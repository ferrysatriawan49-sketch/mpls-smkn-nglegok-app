...
export function getSupabaseCredentials() {
  const url = (import.meta as any).env.VITE_SUPABASE_URL || localStorage.getItem('mpls_supabase_url') || '';
  const anonKey = (import.meta as any).env.VITE_SUPABASE_ANON_KEY || localStorage.getItem('mpls_supabase_anon_key') || '';
